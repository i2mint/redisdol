...
class RedisBytesPersister(RedisBytesReader, KvPersister):
    ...
    Note: You need to have a redis server running (on the port chosen by default by
    ``RedisBytesPersister``, etc.) to perform the following:
